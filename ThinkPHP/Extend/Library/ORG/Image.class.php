...
class Image {
     ...
     * @return string
     */
    static function codeimage($length=4, $type='png', $width=70, $height=30, $fontsize=18,$verifyName='verify') {
    	import('ORG.String');
    	$randval = String::randString($length);
...
//     	}
    	...
    	for ($i = 0; $i < $length; $i++){
    		...
    		imagettftext($im,$fontsize,mt_rand(-30,30),$_x*$i+mt_rand(1,4),$height/1.4,$color,$font,$randval{$i});
    	}
